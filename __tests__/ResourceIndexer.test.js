...
describe('ResourceIndexer', () => {
  describe('Resource', () =>{
    const doc = {
      'data': [
        {
          '@id': 'https://api.development.sinopia.io/resource/860e40cb-8c63-4014-90f4-4682d25780a8',
          '@type': [
    ...
    it('indexes', async () => {
      ...
      expect(new ResourceIndexer(doc, dataset).index()).toEqual({
        uri: 'https://api.development.sinopia.io/resource/860e40cb-8c63-4014-90f4-4682d25780a8',
        label: 'https://api.development.sinopia.io/resource/860e40cb-8c63-4014-90f4-4682d25780a8',
